# 🎭 BẢN ĐỒ TƯ DUY VĂN HỌC TINH GỌN (4-5 TẦNG): HỒI 5 - Phát hiệu triệu, các trấn hưởng ứng Tào Công
...
- 📌 **🎭 [Khung Cốt Truyện & Biến Cố Chủ Đạo]**
  - 🔹 *Khởi đầu:* ➔ *Bối cảnh hồi* ➔ *Mầm mống xung đột* ➔ *Hành động mở đầu (Phát hiệu triệu, các)*
  - 🔹 *Thắt nút:* ➔ *Xung đột leo thang* ➔ *Toan tính mưu lược* ➔ *Rẽ nhánh tình thế*
  - 🔹 *Cao trào:* ➔ *Đỉnh điểm đấu trí* ➔ *Giao phong sinh tử* ➔ *Biến cố quyết định (Phá cửa quan, ba anh)*
...
| :--- | :--- | :--- | :--- |
| **Lã Bố** | Vô Địch Dũng Lực & Bất Nhân Bất Nghĩa | Quyết sách hàng đầu trong hành động "Phát hiệu triệu, các trấn" | Thể hiện bản lĩnh cá nhân |
| **Lưu Bị** | Nhân Nghĩa Nho Gia Chính Thống | Đối kháng hoặc phản ứng trước biến cố "Phá cửa quan, ba anh hùng" | Bài học nhân tâm thời loạn |
| **Phát hiệu triệu, c** | Sự Kiện Khởi Phát | Mở màn cho chuỗi xung đột trong Hồi Kỳ 1 | Mầm mống biến thiên lịch sử |
| **Phá cửa quan, ba a** | Sự Kiện Cao Trào | Đỉnh điểm phân định thắng bại cục bộ | Quy luật chuyển dịch quyền lực |
