...
# -*- coding: utf-8 -*-
"""
Builder for Chapters 01 to 05 Summaries and Mindmaps (v2.4)
...
# CHAPTER 02
# ==============================================================================
C02_SUMMARY = """# Tóm Tắt: CHƯƠNG 2: CHỦ ĐỘNG LỰA CHỌN LÒNG DŨNG CẢM
...
C02_MINDMAP = """# 🧠 BẢN ĐỒ TƯ DUY TINH GỌN (4-5 TẦNG): CHƯƠNG 2 - CHỦ ĐỘNG LỰA CHỌN LÒNG DŨNG CẢM

## 1. Sơ Đồ Tư Duy Trực Quan (Mermaid Mindmap Tinh Gọn)

```mermaid
mindmap
  root((CHỦ ĐỘNG DŨNG CẢM))
    🧭 Mở Rộng Biên Độ
      Hành vi vi mô
        Kim Scott
          Radical Candor
...
# Write Chapter 2 files
c2_dir = os.path.join(BASE_DIR, "02-Choose-courage")
with open(os.path.join(c2_dir, "summary.md"), "w", encoding="utf-8") as f:
    f.write(C02_SUMMARY.strip() + "\n")
with open(os.path.join(c2_dir, "mindmap.md"), "w", encoding="utf-8") as f:
    f.write(C02_MINDMAP.strip() + "\n")
print("[✓] Chapter 02 files written successfully.")
