...
# -*- coding: utf-8 -*-
"""
Builder for Chapter 08: Inquire and advocate
"""
import os
...
C08_SUMMARY = """# Tóm Tắt: CHƯƠNG 8: HỎI THĂM DÒ VÀ TRÌNH BÀY QUAN ĐIỂM
...
C08_MINDMAP = """# 🧠 BẢN ĐỒ TƯ DUY TINH GỌN (4-5 TẦNG): CHƯƠNG 8 - HỎI THĂM DÒ VÀ TRÌNH BÀY QUAN ĐIỂM
...
c8_dir = os.path.join(BASE_DIR, "08-Inquire-and-advocate")
with open(os.path.join(c8_dir, "summary.md"), "w", encoding="utf-8") as f:
    f.write(C08_SUMMARY.strip() + "\n")
with open(os.path.join(c8_dir, "mindmap.md"), "w", encoding="utf-8") as f:
    f.write(C08_MINDMAP.strip() + "\n")
print("[✓] Chapter 08 files written successfully.")
